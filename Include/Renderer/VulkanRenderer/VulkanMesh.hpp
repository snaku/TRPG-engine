...
#include <Renderer/VulkanRenderer/UniformBufferObject.hpp>
...
public:
    ...
    void updatePushConstantData(const glm::mat4& model, const glm::vec3& lightDir);
...
private:
    ...
    glm::vec3 pushConstantLightDir_;
};